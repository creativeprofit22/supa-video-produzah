...
[Dependency and full-history secret policy](security/README.md) defines the CI release gates, exact local commands and reviewed exceptions. Audit jobs require network access separately from offline application tests; scanner severity is not proof of a shipped exploit.
